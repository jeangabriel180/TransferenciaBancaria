...
import com.jean.gabriel.TransferenciaBancaria.adapters.out.repository.ConsultarContaRemetentePorId;
...
class ConsultarContaRemetentePorIdTest {

    @Mock
    private ContaRepository contaRepository;

    @InjectMocks
    private ConsultarContaRemetentePorId consultarContaRemetentePorId;
    ...
    void deveConsultarContaComSucesso() {
        ...
        Conta contaRetornada = consultarContaRemetentePorId.consultarContaPorId("54862354123");
    ...
    void deveFalharAoConsultarContaInexistente() {
        ...
        assertThrows(ErroContaNaoEncontradaException.class,
                () -> consultarContaRemetentePorId.consultarContaPorId("1234567911"));
    }
    ...
    void deveLancarExcecaoAoConsultarConta() {
        ...
        assertThrows(ErroContaNaoEncontradaException.class,
                () -> consultarContaRemetentePorId.consultarContaPorId("45632059871"));
    }
}
